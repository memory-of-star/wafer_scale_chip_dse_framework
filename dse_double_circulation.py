...
def process(points_dict, output_path, threshold = 0, **optimizer_kwargs):
...
for i in range(0, 1):
    ...
    choose_model = i
    p = Process(target=process, args=(points_dic2, 'result/log_multifidelity_model{}_double_circulate'.format(i), -1e11), kwargs=optimizer_kwargs)
    p.start()
